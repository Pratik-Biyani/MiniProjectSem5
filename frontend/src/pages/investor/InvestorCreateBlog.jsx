...
const InvestorCreateBlog = () => {
  ...
  const [formData, setFormData] = useState({
    ...
    content: '',
    tags: '',
    authorName: 'Investor User',
    authorRole: 'investor',
    authorId: investor_id
  });
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6 mb-6">
          ...
          <p className="text-gray-600">
            Share your investment insights and market analysis
          </p>
        </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div>
              ...
              <textarea
                ...
                rows="12"
                className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                placeholder="Share your investment insights, market analysis, or advice for startups..."
              />
            </div>
            ...
            <div>
              ...
              <input
                ...
                onChange={handleChange}
                className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                placeholder="investment, funding, startup, market, trends"
              />
            ...
            <div className="flex items-center justify-end space-x-4 pt-6 border-t border-gray-200">
              <button
                type="button"
                onClick={() => navigate(`/investor/${investor_id}/blogs`)}
